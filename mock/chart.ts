        ...
        response: () => {
            return {
                ...
                data: [
                    {
                        name: "18岁以下",
                        value: parseInt(String(Math.random() * 1200)),
                    },
                    {
                        name: "18-25",
                        value: parseInt(String(Math.random() * 2000)),
                    },
                    {
                        name: "25-35",
                        value: parseInt(String(Math.random() * 1800)),
                    },
                    {
                        name: "35-50",
                        value: parseInt(String(Math.random() * 1700)),
                    },
                    {
                        name: "50-65",
                        value: parseInt(String(Math.random() * 1500)),
                    },
                    {
                        name: "65以上",
                        value: parseInt(String(Math.random() * 1400)),
                    },
                ],
            };
        },
