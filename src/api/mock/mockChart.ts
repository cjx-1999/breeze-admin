...
export function selectWordData(params: any) {
...
export function selectBoxChartData(params: any) {
...
export function selectOtherData(params: any) {
...
export function selectYearValue(params: any) {
